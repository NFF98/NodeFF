...
> Spec Status：SPEC_READY — APPROVED SHARED CONTRACT
>
> Promoted from Working：working/DATA-MODEL.md
>
> Promotion Source Commit：3e3439b9b526ce94b590c1b491ae721e6b8bd6eb
>

> Working Source Status at Promotion：Working Baseline / Phase 1。本文是 NodeFF 共享資料模型的 Current Truth。它定義跨 Function 共用的 entity、identity、durability、relation、DB responsibility、privacy boundary 與未來 migration hooks。Function 專屬的 request/response payload、UI state、processing logic 仍由各 Fxx 文件定義。
>
...
# 16. Future Migration Hooks

## 16.1 F08 Identity / Ownership
...
# 18. Cursor Implementation Boundary
...
# 20. Open Function-level Decisions
