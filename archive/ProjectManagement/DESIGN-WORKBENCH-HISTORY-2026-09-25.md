...
>
> This is the pre-cleanup Workbench snapshot preserved for audit/history. Canonical Product Design Truth remains in `working/`. Resolved architecture items were absorbed into their canonical owners before the active Workbench was slimmed.
